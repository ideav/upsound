...
return array(
    ...
    // Холостой прогон: файлы читаются и разбираются, в лог пишется, что было бы сделано,
    // но импорт не отправляется, файл не отмечается обработанным, списки и БД не меняются.
    // Для запуска по крону, где переменную окружения USYNC_DRY_RUN задать негде.
    'dry_run' => false,
